...
**异常状态**是诺艾儿在战斗等事件中获取的负面状态效果。

一些异常状态具有多个等级，通常更高的等级会继承低等级的所有效果，并进一步增强效果。

# 效果列表

| 图标 | 名称 | 描述 |
| - | - | - |
|  | 濒死 | 【HP 低于最大 HP 的 15%】HP为 0 时将失去行动能力。 |
| ![](/assets/global/icons/abnormality/mp_reduce.png =32x){ .buff-icon } | 枯竭 | 【MP 低于最大 MP 的 15%】无法奔跑或进行闪避。 |
|  | 无法战斗 | 【HP 为 0】在魔物们心满意足之前，请耐心等待吧。 |
| ![](/assets/global/icons/abnormality/clt_torned.png =32x){ .buff-icon }  | 服装损坏 | 衣服破破烂烂的。坐在长椅上可以重新修补好。（启用 “衣损惩罚” 时：受到的伤害变为原来的 1.5 倍。闪避的无敌时间延长。） |
...
| ![](/assets/global/icons/abnormality/paralysis_2.png =32x){ .buff-icon } | 麻痹 Lv.2 | 效果增强。 |
...
| ![](/assets/global/icons/abnormality/confuse_3.png =32x){ .buff-icon } | 混乱 Lv.3 | 状态页面和物品页面的文字变成乱码。 |
...
| ![](/assets/global/icons/abnormality/parasitised_2.png =32x){ .buff-icon } | 植物寄生 Lv.2 | 效果增强。 |
| ![](/assets/global/icons/abnormality/parasitised_3.png =32x){ .buff-icon } | 植物寄生 Lv.3 | 效果增强。 |
| ![](/assets/global/icons/abnormality/shame_1.png =32x){ .buff-icon } | 羞耻 | 因为羞耻导致精神难以集中的状态。虽然在和敌人接触时更不容易摔倒，但在咏唱时受到攻击的话更容易散落魔力。 |

...
简单来说，料理饱腹度的消耗量与战斗点危险度成正比。除饮品外，越是先食用的料理饱腹度消耗越快，拥有空腹加成的料理饱腹度消耗速度翻倍。饮品的饱腹度消耗速度不受饮用顺序影响。饮品和干粮的消耗速度分别拥有135%和250%的倍率乘算。诺艾儿战败时，所有料理的饱腹度消耗翻倍。

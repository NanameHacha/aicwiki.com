...
## 触发
- 击杀木偶店主后，一些战斗点有概率被替换为木偶复仇战。可以触发木偶复仇战的战斗点详见[战斗点列表](/zh/battle-locations#战斗点列表)。
...
- 发生在拓荒者山岳的木偶复仇战会固定掉落以下宝箱：素材++、煤炭1、矿石3。击杀复仇战中的污染体还可能额外掉落以下秘密宝箱：宝石+（它有 40% 的概率劣化为煤炭1、火药1、宝石1中的一种）、矿石+（它有 40% 的概率劣化为矿石1、矿石2、矿石3中的一种）。

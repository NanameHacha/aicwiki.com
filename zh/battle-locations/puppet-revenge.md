...
## 魔物生成
- 木偶复仇战中，会出现许多强大的魔物与诺艾儿战斗。其中[机甲木偶（污染体）](/zh/enemy/armoured-wooden-puppet-contaminated)和[机甲木偶](/zh/enemy/armoured-wooden-puppet)是木偶复仇战中的特有魔物。与普通战斗点不同的是，木偶复仇战中魔物的数量和种类并不是由当前危险度决定的，而是由复仇战进行度决定的。
...
- 雷雨天时，木偶仍有概率会转化为木偶（污染体），但机甲木偶不会转化为木偶（污染体）。

## 宝箱

- 发生在编织者之森的木偶复仇战会固定掉落以下宝箱：素材+、矿石2、矿石3、魔族素材3。击杀复仇战中的污染体还可能额外掉落以下宝箱：矿石+（它有40%的概率劣化为矿石1、矿石2或矿石3中的一种）。
- 发生在拓荒者山岳的木偶复仇战会固定掉落以下宝箱：素材++、煤炭1、矿石3。击杀复仇战中的污染体还可能额外掉落以下宝箱：宝石+（它有40%的概率劣化为宝石1、火药1或煤炭1中的一种）、矿石+（它有40%的概率劣化为矿石1、矿石2或矿石3中的一种）。
- 独立于上述战斗掉落，机甲木偶（污染体）还可能额外掉落以下宝箱：素材++（或其名称变种，变种的内容与其完全相同，仅名称上存在差异）。

<!--
（旧版本留档）
- 机甲木偶有概率掉落**宝箱：素材++、宝箱：素材+++1、宝箱：素材+++2、宝箱：素材+++3、宝箱：素材+++4** 中的其中一个（当前版本**宝箱：素材+++1、宝箱：素材+++2、宝箱：素材+++3、宝箱：素材+++4** 的内容与**宝箱：素材++** 一致）。
-->
